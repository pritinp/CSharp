...
namespace WorkingWithCollections
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //// List<T>
            //List<Car> myList = new List<Car>(); // We create a 'List' Collection, and specify that it will only hold the 'Car' datatype
            //myList.Add(car1);
            //myList.Add(car2);
            ////myList.Add(b1); // this is not allowed - we can't add a 'book' datatype to the 'Car' List Collection
